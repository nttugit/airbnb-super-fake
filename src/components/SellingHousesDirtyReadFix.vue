...
const OWNER_SELLING_HOUSE_DIRTY_READ_FIX_ROUTE = import.meta.env
  .VITE_OWNER_SELLING_HOUSE_DIRTY_READ_FIX_ROUTE;
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        const getSellingHousesAPI = `${API_URL}/${OWNER_SELLING_HOUSE_DIRTY_READ_FIX_ROUTE}/${this.userID}`;
