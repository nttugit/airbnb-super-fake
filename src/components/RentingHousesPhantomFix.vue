...
const OWNER_RENTING_HOUSE_PHANTOM_FIX_ROUTE = import.meta.env
  .VITE_OWNER_RENTING_HOUSE_PHANTOM_FIX_ROUTE;
const PHOTOS = [
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        const getRentingHousesAPI = `${API_URL}/${OWNER_RENTING_HOUSE_PHANTOM_FIX_ROUTE}/${this.userID}`;
